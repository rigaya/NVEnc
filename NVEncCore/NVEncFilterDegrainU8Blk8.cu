...
RGY_ERR launchNVEncDegrainMotionSearchSearchParallelU8Blk8(
    ...
    return launchNVEncDegrainMotionSearchSearchParallelBlock<uint8_t, 8>(
...
RGY_ERR launchNVEncDegrainMotionSearchSpatialRefineU8Blk8(
    ...
    return launchNVEncDegrainMotionSearchSpatialRefineBlock<uint8_t, 8>(
