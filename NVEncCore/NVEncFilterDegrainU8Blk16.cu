...
RGY_ERR launchNVEncDegrainMotionSearchSearchParallelU8Blk16(
    ...
    return launchNVEncDegrainMotionSearchSearchParallelBlock<uint8_t, 16>(
...
RGY_ERR launchNVEncDegrainMotionSearchSpatialRefineU8Blk16(
    ...
    return launchNVEncDegrainMotionSearchSpatialRefineBlock<uint8_t, 16>(
