...
RGY_ERR launchNVEncDegrainMotionSearchSearchParallelU16Blk16(
    ...
    return launchNVEncDegrainMotionSearchSearchParallelBlock<uint16_t, 16>(
...
RGY_ERR launchNVEncDegrainMotionSearchSpatialRefineU16Blk16(
    ...
    return launchNVEncDegrainMotionSearchSpatialRefineBlock<uint16_t, 16>(
