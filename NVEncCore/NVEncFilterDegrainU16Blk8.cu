...
RGY_ERR launchNVEncDegrainMotionSearchSearchParallelU16Blk8(
    ...
    return launchNVEncDegrainMotionSearchSearchParallelBlock<uint16_t, 8>(
...
RGY_ERR launchNVEncDegrainMotionSearchSpatialRefineU16Blk8(
    ...
    return launchNVEncDegrainMotionSearchSpatialRefineBlock<uint16_t, 8>(
